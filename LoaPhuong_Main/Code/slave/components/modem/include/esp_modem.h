...
////phinht: add hw version define
//#define	HW_VERSION	3
//
//#if (HW_VERSION == 2)
//#warning "CHU Y DANG BUILD HW_VERSION = 1.0.2A, DUNG IOEX PCF"
//#define	MODEM_UART_TX_PIN	12
//#define	MODEM_UART_RX_PIN	14
//#elif (HW_VERSION == 3)
//#warning "CHU Y DANG BUILD HW_VERSION = 2.0.3, DUNG IOEX STM32/GD32"
#define	MODEM_UART_TX_PIN	12	//14
#define	MODEM_UART_RX_PIN	14	//34
//#endif
...
typedef enum {
    ...
    MODEM_EVENT_INIT_DONE,		/* GSM module init done */
