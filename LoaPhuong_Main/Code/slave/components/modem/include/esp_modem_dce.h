...
#define MODEM_IMEI_LENGTH (24)         /*!< IMEI Number Length */
#define MODEM_IMSI_LENGTH (25)         /*!< IMSI Number Length */

#define	MODEM_NETWORK_INFO_LENGTH	(50)	/*!< Network infomation length */
#define MODEM_ACCESS_TECH_LENGTH (20)         /*!< Access tech Length */
#define MODEM_NETWORK_BAND_LENGTH (25)         /*!< Network band Length */
#define MODEM_NETWORK_CHANNEL_LENGTH (15)         /*!< Network channgel Length */
 ...
 *
 */
#define MODEM_COMMAND_TIMEOUT_DEFAULT (1000)      /*!< Default timeout value for most commands */
...
struct modem_dce {
	...
	char sim_imei[MODEM_IMSI_LENGTH + 1];                                             /*!< IMSI number */
    char name[MODEM_MAX_NAME_LENGTH];                                                 /*!< Module name */
    char oper[MODEM_MAX_OPERATOR_LENGTH + 1];                                         /*!< Operator name */
	
	char accessTech[MODEM_ACCESS_TECH_LENGTH + 1];
	char networkBand[MODEM_NETWORK_BAND_LENGTH + 1];
	char networkChannel[MODEM_NETWORK_CHANNEL_LENGTH + 1];
	uint8_t isGetNetworkInfo ;										  				  /*!< Network infomation */
	uint8_t rssi;
